					...
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								...
								<li><a href="shop2.html">DRINKWARE</a></li>
						...
						<div class="hero-text">
							<div class="hero-text-tablecell">
								...
								<div class="hero-btns">
									...
									<a href="index.html#team" class="bordered-btn">Barista</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-10 offset-lg-1 text-center">
						<div class="hero-text">
							<div class="hero-text-tablecell">
								...
								<div class="hero-btns">
									<a href="shop.html" class="boxed-btn">Visit Shop</a>
									<a href="login.html" class="bordered-btn">Login</a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="footer-box pages">
						...
						<ul>
							...
							<li><a href="shop.html">COFFEE BEANS</a></li>
							<li><a href="shop2.html">GOODS</a></li>
