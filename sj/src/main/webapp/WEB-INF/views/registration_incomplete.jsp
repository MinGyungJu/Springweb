			...
			<div class="full-height-tablecell">
				<div class="container">
					<div class="row">
						<div class="col-lg-8 offset-lg-2 text-center">
							<div class="joinUs">
								<h1 style = "color:#CA965C;">Sorry</h1><br/><br/>
								<h3>We couldn't make your accout.</h3>
								<h3>Error: duplicate ID</h3><br/><br/>
								<a href="registration.do" class="boxed-btn">Go back to registration</a>
							</div>
						</div>
					</div>
				</div>
