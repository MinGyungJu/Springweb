         ...
         <div class="row">
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
                            <a href = "shop2.do"><li>All</li></a>
                            <a href = "shop2_extraction.do"><li class="active">Extraction Tool</li></a>
				...
				<div class="pagination-wrap">
					 ...
					 <ul>
						    ...
						    <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
						    	<li><a href="shop2_extraction.do${pageMaker.makeQuery(idx)}">${idx}</a></li>
						    </c:forEach>
