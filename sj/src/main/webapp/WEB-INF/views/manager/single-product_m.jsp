...
<link rel="shortcut icon" type="image/png"
	href="<%=pjName%>resources/assets/img/favicon.png">
<!-- google font -->
<link
...
<!-- fontawesome -->
<link rel="stylesheet"
	href="<%=pjName%>resources/assets/css/all.min.css">
<!-- bootstrap -->
<link rel="stylesheet"
	href="<%=pjName%>resources/assets/bootstrap/css/bootstrap.min.css">
<!-- owl carousel -->
<link rel="stylesheet"
	href="<%=pjName%>resources/assets/css/owl.carousel.css">
<!-- magnific popup -->
<link rel="stylesheet"
	href="<%=pjName%>resources/assets/css/magnific-popup.css">
<!-- animate css -->
<link rel="stylesheet"
	href="<%=pjName%>resources/assets/css/animate.css">
<!-- mean menu css -->
<link rel="stylesheet"
	href="<%=pjName%>resources/assets/css/meanmenu.min.css">
<!-- main style -->
...
<body>
			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 text-center">
					<div class="main-menu-wrap">
						...
						<div class="site-logo">
							<a href="index.do"> <img
								src="<%=pjName%>resources/assets/img/logo.png" alt="">
							</a>
						</div>
						<!-- logo -->
			...
			<div class="row">
				<div class="col-md-5">
					<div class="single-product-img">
						<img
							src="<%=pjName%>resources/assets/img/products/product-img-5.jpg"
							alt="">
				...
				<div class="col-md-7">
					<div class="single-product-content">
						<textarea name="" id="" class="col-lg-6 col-md-12"
							placeholder="Product ID"></textarea>
						<textarea name="" id="" class="col-lg-6 col-md-12"
						...
						<textarea name="" id="" class="col-lg-6 col-md-12"
							placeholder="Context" rows="2"></textarea>
						<form action="shop_m.do">
							<div class="single-product-form">
								<input type="number" placeholder="0"><br/> 
								<input type="submit" value="Modify"> <input type="submit" value="Add New">
							</div>
						</form>
				</div>
			</div>
	...
	<!-- isotope -->
	<script
		src="<%=pjName%>resources/assets/js/jquery.isotope-3.0.6.min.js"></script>
	<!-- waypoints -->
	...
	<!-- magnific popup -->
	<script
		src="<%=pjName%>resources/assets/js/jquery.magnific-popup.min.js"></script>
	<!-- mean menu -->
