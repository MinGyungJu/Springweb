					...
					<h3>Modifying Member Information</h3>
                     ...
                     <p>
                        ...
                        <select name="gender" id="gender">
                           ...
                           <option <c:if test="${sessionScope.loginGender ne Male}"> selected="selected"</c:if>>Check Gender</option>
                           <option <c:if test="${sessionScope.loginGender eq Male}"> selected="selected"</c:if>>Male</option>
                     ...
                     <p>
                        <input type="tel" placeholder="Phone" name="tel" id="tel" value="${ sessionScope.loginTel}" required>&nbsp;&nbsp;
                        <input type="email" placeholder="Email" name="email" id="email" value="${ sessionScope.loginEmail}" required>
                     </p>
                     <p>
                     	<input type="text" name = "addr" id = "addr_postcode" onclick="findAddress()" placeholder="postcode" value="${ sessionScope.loginAddr}" readonly>
                     </p>
                     <p>
                     </p>
                     <p>
