									...
									<div class="header-icons">
										...
										<a class="mobile-hide search-bar-icon" href="#"><i class="fas fa-search"></i></a>
											<c:if test="${sessionScope.loginId==null}">	
												<a class="shopping-cart" href="login_m.do"><i class="fas fa-shopping-cart"></i></a>
											</c:if>
										<ul class="sub-menu">
											<c:if test="${sessionScope.loginId==null}">	
			...
			<div class="row product-lists">
				<c:forEach items="${productList}" var="product"> 
					<div class="col-lg-4 col-md-6 text-center ${product.type}">
						<form action="single_product_m.do" >
							<div class="single-product-item"> 
								<div class="product-image clickable-div" onclick="location.href='single_product_modify_m_m.do?pno=${product.pno}&img=${product.img}&pname=${product.pname}&price=${product.price}&description=${product.description}&stock=${product.stock}';">
