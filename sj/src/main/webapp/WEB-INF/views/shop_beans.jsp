                ...
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
                            ...
                            <a href = "shop_capsule.do"><li>Capsule</li></a>
                            <a href = "shop_dripbag.do"><li>Dripbag</li></a>
                            <a href = "shop_beans.do"><li class="active">Beans</li></a>
                        </ul>
                    </div>
                </div>
            </div>
			...
			<div class="row">
			 ...
			 <ul>
			    ...
			    <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
			    	<li><a href="shop_beans.do${pageMaker.makeQuery(idx)}">${idx}</a></li>
			    </c:forEach>
